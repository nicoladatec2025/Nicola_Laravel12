    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                @can('create-permission')
                    <a href="{{ route('permissions.create') }}" class="btn-success align-icon-btn">
        ...
        <form class="form-search">
            ...
            <div class="flex gap-1">
                ...
                <a href="{{ route('permissions.index') }}" type="submit" class="btn-warning flex items-center space-x-1">
