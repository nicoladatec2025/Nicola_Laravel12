    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('create-module')
                    <a href="{{ route('modules.create', ['courseBatch' => $courseBatch->id]) }}"
                ...
                <tbody>
                    ...
                    @forelse ($modules as $module)
                        <tr class="table-row-body">
                            <td class="table-body">{{ $module->id }}</td>
                            <td class="table-body">{{ $module->name }}</td>
                            <td class="table-body hidden lg:table-cell">
                                @can('show-course-batch')
                                    <a
                                        href="{{ route('course_batches.show', ['courseBatch' => $courseBatch->id]) }}">{{ $courseBatch->name }}</a>
                                @elsecan()
                                    {{ $courseBatch->name }}
                                @endcan
                            </td>
                                ...
                                <div class="table-actions-align">
                                    ...
                                    @can('destroy-module')
                                        <form id="delete-form-{{ $module->id }}"
                                            action="{{ route('modules.destroy', ['module' => $module->id]) }}" method="POST">
                                            @csrf
                                            @method('delete')
