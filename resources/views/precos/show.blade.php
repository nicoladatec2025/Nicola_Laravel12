    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('edit-conta')
                    <a href="{{ route('conta.edit', ['conta' => $conta->id]) }}" class="btn-warning align-icon-btn">
                ...
                @can('destroy-conta')
                    <form id="delete-form-{{ $conta->id }}" action="{{ route('conta.destroy', ['conta' => $conta->id]) }}"
                        method="POST">
                        @csrf
                        @method('delete')
        ...
        <div class="detail-box">
            ...
            <div class="mb-1">
                <span class="title-detail-content">ID: {{ $conta->id }}</span>
            </div>

            <div class="mb-1">
                <span class="title-detail-content">Nome: {{ $conta->nome }}</span>
           </div>

            <div class="mb-1">
                <span class="title-detail-content">Valor: {{ $conta->valor }} Kz</span>
                 </div>
            ...
            <div class="mb-1">
                ...
                <dt class="title-detail-content">Cadastrado: {{ \Carbon\Carbon::parse($conta->created_at)->tz('Africa/Luanda')->format('d/m/Y H:i:s') }}</dt>


                <dt class="title-detail-content">Editado: {{ \Carbon\Carbon::parse($conta->updated_at)->tz('Africa/Luanda')->format('d/m/Y H:i:s') }}</dt>
