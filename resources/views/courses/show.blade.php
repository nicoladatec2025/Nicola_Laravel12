    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('edit-course')
                    <a href="{{ route('courses.edit', ['course' => $course->id]) }}" class="btn-warning align-icon-btn">
                ...
                @can('destroy-course')
                    <form id="delete-form-{{ $course->id }}" action="{{ route('courses.destroy', ['course' => $course->id]) }}" method="POST">
                        @csrf
                        @method('delete')
        ...
        <div class="detail-box">
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ $course->id }}</span>
            </div>
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ $course->courseStatus->name }}</span>
            </div>

            <div class="mb-1">
                <span class="title-detail-content">Cadastrado: </span>
                <span class="detail-content">{{ \Carbon\Carbon::parse($course->created_at)->format('d/m/Y H:i:s') }}</span>
            </div>

            <div class="mb-1">
                <span class="title-detail-content">Editado: </span>
                <span class="detail-content">{{ \Carbon\Carbon::parse($course->updated_at)->format('d/m/Y H:i:s') }}</span>
            </div>
