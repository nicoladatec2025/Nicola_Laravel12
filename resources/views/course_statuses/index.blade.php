        ...
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                @can('create-course-status')
                    <a href="{{ route('course_statuses.create') }}" class="btn-success align-icon-btn">
                ...
                <tbody>
                    ...
                    @forelse ($coursesStatuses as $courseStatus)
                        <tr class="table-row-body">
                            <td class="table-body">{{ $courseStatus->id }}</td>
                            <td class="table-body">{{ $courseStatus->name }}</td>
                            <td class="table-actions">
                                <div class="table-actions-align">
                                    @can('show-course-status')
                                        <a href="{{ route('course_statuses.show', ['courseStatus' => $courseStatus->id]) }}"
                                    ...
                                    @can('edit-course-status')
                                        <a href="{{ route('course_statuses.edit', ['courseStatus' => $courseStatus->id]) }}"
                                    ...
                                    @can('destroy-course-status')
                                        <form id="delete-form-{{ $courseStatus->id }}"
                                            action="{{ route('course_statuses.destroy', ['courseStatus' => $courseStatus->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
