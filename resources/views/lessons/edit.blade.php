    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                @can('index-lesson')
                    <a href="{{ route('lessons.index', ['module' => $lesson->module_id]) }}"
                ...
                @can('show-lesson')
                    <a href="{{ route('lessons.show', ['lesson' => $lesson->id]) }}" class="btn-primary align-icon-btn">
                        <!-- Ícone eye (Heroicons) -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <form action="{{ route('lessons.update', ['lesson' => $lesson->id]) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="form-input"
                    placeholder="Nome da aula" value="{{ old('name', $lesson->name) }}" required>
            </div>
