    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('show-module')
                    <a href="{{ route('modules.show', ['module' => $module->id]) }}" class="btn-primary align-icon-btn">
                        <!-- Ícone eye (Heroicons) -->
                ...
                @can('create-lesson')
                    <a href="{{ route('lessons.create', ['module' => $module->id]) }}" class="btn-success align-icon-btn">
            ...
            <table class="table">
                <thead>
                    <tr class="table-row-header">
                        ...
                        <th class="table-header hidden lg:table-cell">Turma</th>
                ...
                <tbody>
                    ...
                    @forelse ($lessons as $lesson)
                        <tr class="table-row-body">
                            <td class="table-body">{{ $lesson->id }}</td>
                            <td class="table-body">{{ $lesson->name }}</td>
                                ...
                                <div class="table-actions-align">
                                    ...
                                    @can('destroy-lesson')
                                        <form id="delete-form-{{ $lesson->id }}"
                                            action="{{ route('lessons.destroy', ['lesson' => $lesson->id]) }}" method="POST">
                                            @csrf
                                            @method('delete')
