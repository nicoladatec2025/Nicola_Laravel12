    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('generate-pdf-users')
                    <a href="{{ url('users/generate-pdf/users') . (request()->getQueryString() ? '?' . request()->getQueryString() : '') }}"
                ...
                @can('generate-csv-users')
                    <a href="{{ url('users/generate-csv/users') . (request()->getQueryString() ? '?' . request()->getQueryString() : '') }}"
