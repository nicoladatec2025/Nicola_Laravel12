    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('destroy-user-status')
                    <form id="delete-form-{{ $userStatus->id }}" action="{{ route('user_statuses.destroy', ['userStatus' => $userStatus->id]) }}" method="POST">
                        @csrf
                        @method('delete')

                        <button type="button" onclick="confirmDelete({{ $userStatus->id }})"
        ...
        <div class="detail-box">
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ $userStatus->name }}</span>
            </div>
