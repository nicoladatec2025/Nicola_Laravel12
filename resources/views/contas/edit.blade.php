    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('show-conta')
                    <a href="{{ route('conta.show', ['conta' => $conta->id]) }}" class="btn-primary align-icon-btn">
                        <!-- Ícone eye (Heroicons) -->
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <form action="{{ route('conta.update', ['conta' => $conta->id]) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nome" id="nome" class="form-input"
                    placeholder="Nome da conta" value="{{ old('nome', $conta->nome) }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="valor" id="valor" class="form-input"
                    placeholder="Valor da conta" value="{{  old('valor', isset($conta->valor) ? number_format($conta->valor, '2', ',', '.') : '')  }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="vencimento" id="vencimento" class="form-input"
                    placeholder="Vencimento da conta" value="{{ old('vencimento', $conta->vencimento) }}" required>
            </div>
