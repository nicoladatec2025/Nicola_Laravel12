    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('show-course')
                    <a href="{{ route('courses.show', ['course' => $course->id]) }}" class="btn-primary align-icon-btn">
                        <!-- Ícone eye (Heroicons) -->
                ...
                @can('create-course-batch')
                    <a href="{{ route('course_batches.create', ['course' => $course->id]) }}"
            ...
            <table class="table">
                <thead>
                    <tr class="table-row-header">
                        ...
                        <th class="table-header hidden lg:table-cell">Formando</th>
                ...
                <tbody>
                    ...
                    @forelse ($coursesBatches as $courseBatch)
                        <tr class="table-row-body">
                            <td class="table-body">{{ $courseBatch->id }}</td>
                            <td class="table-body">{{ $courseBatch->name }}</td>
                            ...
                            <td class="table-actions">
                                <div class="table-actions-align">
                                    @can('index-module')
                                        <a href="{{ route('modules.index', ['courseBatch' => $courseBatch->id]) }}"
                                    ...
                                    @can('show-course-batch')
                                        <a href="{{ route('course_batches.show', ['courseBatch' => $courseBatch->id]) }}"
                                    ...
                                    @can('destroy-course-batch')
                                        <form id="delete-form-{{ $courseBatch->id }}"
                                            action="{{ route('course_batches.destroy', ['courseBatch' => $courseBatch->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
